			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>CODIGO:</strong> '.$rows['producto_codigo'].',<br> <strong>APLICA:</strong> '.$rows['producto_aplica'].',<br> <strong>Nro.Parte:</strong>'.$rows['producto_nroparte'].',<br> <strong>Marca:</strong>'.$rows['producto_marca'].',<br> <strong>PRECIO:</strong> $'.$rows['producto_precio'].',<br> <strong>STOCK:</strong> '.$rows['producto_stock'].',<br> <strong>CATEGORIA:</strong> '.$rows['categoria_nombre'].',<br> <strong>REGISTRADO POR:</strong> '.$rows['usuario_nombre'].' '.$rows['usuario_apellido'].'
			              </p>
			            </div>
