<div class="container is-fluid mb-7">
	...
	<form action="./php/producto_guardar.php" method="POST" class="FormularioAjax" autocomplete="off" enctype="multipart/form-data" >
		<div class="columns">
			...
			<div class="column">
		    	<div class="control">
					<label>Aplica</label>
				  	<input class="input" type="text" name="producto_aplica" pattern="[a-zA-Z0-9  ]{1,70}" maxlength="25" required >
				</div>
			</div>
			<div class="column">
		    	<div class="control">
					<label>Marca</label>
				  	<input class="input" type="text" name="producto_marca" pattern="[a-zA-Z0-9   ]{1,70}" maxlength="25" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
			...
			<div class="column">
				<div class="control">
					<label>Nro. Parte</label>
				  	<input class="input" type="text" name="producto_nroparte" pattern="[0-9]{1,25}" maxlength="25" required >
				</div>
			</div>
			<div class="column">
		    	<div class="control">
			...
			<div class="column">
				<label class="file is-centered">Foto o imagen del producto</label><br>
